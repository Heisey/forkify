...
const ingredientTemplate = prop => {
    return `
        <li class="recipe__item">
            <svg class="recipe__icon">
                <use href="img/icons.svg#icon-check"></use>
            </svg>
            <div class="recipe__count">${formatCount(prop.count)}</div>
            <div class="recipe__ingredient">
                <span class="recipe__unit">${prop.unit}</span>
                ${prop.ingredient}
            </div>
        </li>
    `
...
export const renderRecipe = recipe => {
    ...
    const markup = `
        ...
        <div class="recipe__ingredients">
            ...
            ${ingredients.map(el => ingredientTemplate(el)).join('')}
        ...
        <div class="recipe__directions">
            ...
            <a class="btn-small recipe__btn" href="${source_url}">
...
export const updateServingsUI = recipe => {
    document.querySelector('.recipe__info-data--people').textContent = recipe.results.servings;
